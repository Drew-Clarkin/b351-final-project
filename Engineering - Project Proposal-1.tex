...
\begin{enumerate}[wide,labelwidth=!,labelindent=0pt]
	...
	\vspace{1cm}
	\item[] Al Henry Lefebvre \hfill Signature \rule{6cm}{0.15mm} 
	
	\vspace{1cm}
	\item[] Adhithya Guhan \hfill Signature \rule{6cm}{0.15mm} 
	
	\vspace{1cm}
	\item[] Drew Clarkin \hfill Signature \rule{6cm}{0.15mm} 
	
	\vspace{1cm}
	\item[] Dena Shink \hfill Signature \rule{6cm}{0.15mm}
