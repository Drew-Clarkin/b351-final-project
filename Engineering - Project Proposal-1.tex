...
\begin{enumerate}[wide,labelwidth=!,labelindent=0pt]
	...
	\vspace{1cm}
	\item[] Team Member 1: Al Henry Lefebvre \hfill Signature: Al Henry Lefebvre 
	
	\vspace{1cm}
	\item[] Team Member 2: Adhithya Guhan \hfill Signature: Adhithya Guhan 
	
	\vspace{1cm}
	\item[] Team Member 3: Drew Clarkin \hfill Signature: Drew Clarkin
	
	\vspace{1cm}
	\item[] Team Member 4: Dena Shink \hfill Signature: Dena Shink
